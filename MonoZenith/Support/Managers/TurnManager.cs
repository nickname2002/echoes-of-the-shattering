...
public class TurnManager
{
    ...
    {
        var turnTransitionComponentFont = DataManager.GetInstance(g).TransitionComponentFont;
        ...
        _startPlayerTurnSound = DataManager.GetInstance(g).PlayerTurnSound.CreateInstance();
