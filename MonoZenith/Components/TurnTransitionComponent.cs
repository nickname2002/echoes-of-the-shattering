...
public class TurnTransitionComponent : Component
{
    ...
    // Timing settings
    private float _fadeInDuration = 0.5f; // 2 seconds to fade in
    private float _displayDuration = 1f; // Display for 3 seconds
    private float _fadeOutDuration = 0.5f; // 2 seconds to fade out

    public TurnTransitionComponent(Game g, string regionName) : base(g, Vector2.Zero, 0, 0)
    {
